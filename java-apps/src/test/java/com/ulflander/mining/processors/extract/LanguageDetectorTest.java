...
public class LanguageDetectorTest extends AbstractTest {
    ...
    public void ItShortTest () {
        ...
        d.setSurface("Questo testo è ovviamente scritto in italiano. L'obiettivo è che il riconoscimento linguaggio sia efficiente e che quelle poche parole essere considerati lingua italiano.");
        s.submit(d);
    ...
    public void EsShortTest () {
        ...
        d.setSurface("Este texto es, obviamente, escrito en español. El objetivo es que el reconocimiento del lenguaje sea eficiente y que esas pocas palabras se considerarán como que habla español.");
        s.submit(d);
    ...
    public void DeShortTest () {
        ...
        d.setSurface("Dieser Text wird natürlich in Deutsch geschrieben. Das Ziel ist, dass die Spracherkennung effizient sein, und dass diese wenigen Worten wie Deutsch sprech berücksichtigt werden.");
        s.submit(d);

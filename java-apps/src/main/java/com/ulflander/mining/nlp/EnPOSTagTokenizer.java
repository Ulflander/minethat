...
public final class EnPOSTagTokenizer extends Tokenizer {
    ...
    public String[] normalizeNER(final String nerSurface) {
        return nerSurface
                ...
                .replaceAll("([^\\s]+)/(TIME)", " $1/$2 ")
                .replaceAll("([^\\s]+)/(LOCATION)", " $1/$2 ")
                .replaceAll("([^\\s]+)/(ORGANIZATION)", " $1/$2 ")
                .replaceAll("([^\\s]+)/(PERSON)", " $1/$2 ")
                .replaceAll("([^\\s]+)/(MONEY)", " $1/$2 ")
                .replaceAll("([^\\s]+)/(PERCENT)", " $1/$2 ")
                .replaceAll("([^\\s]+)/(DATE)", " $1/$2 ")
                .replaceAll("([\\.,;\"”‘`:?!\\-']+)/O", " $1/O ")

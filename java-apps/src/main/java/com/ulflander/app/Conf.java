...
public final class Conf {
     ...
     * Corpora host.
     */
    private static String corporaHost;
     ...
     * @return Corpora host
     */
    public static String getCorporaHost() {
        return corporaHost;
    }
     ...
     * Set services host.
     *
     * @param c Corpora host
     */
    public static void setCorporaHost(final String c) {
        corporaHost = c;
    }
     ...
     * @return Corpora port
     */
    public static int getCorporaPort() {
        return corporaPort;
    }

...
%JAVACMD% %JAVA_OPTS% %EXTRA_JVM_ARGUMENTS% -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="miner_service" -Dapp.repo="%REPO%" -Dbasedir="%BASEDIR%" com.ulflander.app.services.MinerService %CMD_LINE_ARGS%

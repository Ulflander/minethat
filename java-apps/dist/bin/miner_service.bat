...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="miner_service" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" com.ulflander.app.services.MinerService %CMD_LINE_ARGS%

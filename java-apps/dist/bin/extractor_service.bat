...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="extractor_service" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" com.ulflander.app.services.ExtractorService %CMD_LINE_ARGS%

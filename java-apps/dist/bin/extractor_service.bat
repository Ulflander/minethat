...
%JAVACMD% %JAVA_OPTS% %EXTRA_JVM_ARGUMENTS% -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="extractor_service" -Dapp.repo="%REPO%" -Dbasedir="%BASEDIR%" com.ulflander.application.services.ExtractorService %CMD_LINE_ARGS%

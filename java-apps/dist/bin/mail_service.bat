...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="mail_service" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" com.ulflander.app.services.MailInputService %CMD_LINE_ARGS%

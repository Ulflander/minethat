...
%JAVACMD% %JAVA_OPTS% %EXTRA_JVM_ARGUMENTS% -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="mail_service" -Dapp.repo="%REPO%" -Dbasedir="%BASEDIR%" com.ulflander.application.services.MailInputService %CMD_LINE_ARGS%
